 ...
 */
public class PrologueStage1 extends World
{
    ...
    public PrologueStage1(Player player){
        super(1280, 720, 1);
        this.player = player;
        prepare();
    }
    
    public PrologueStage1(Archer archer){
        super(1280, 720, 1);
        this.archer = archer;    
        prepare();
    }
    ...
    public void act(){
        if(Greenfoot.mouseClicked(continueBtn)){
            ...
            Greenfoot.delay(62);
            if(this.player != null){
                Greenfoot.setWorld(new CutsceneStage1(this.player));    
            }
            
            else if(this.archer != null){
                Greenfoot.setWorld(new CutsceneStage1(this.archer));
            }
