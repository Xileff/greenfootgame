 ...
 */
public class PrologueStage2 extends World
{
    ...
    public PrologueStage2(Player player){
        super(1280, 720, 1);
        this.player = player;
        prepare();
    }
    
    public PrologueStage2(Archer archer){
        super(1280, 720, 1);
        this.archer = archer;
        prepare();
    }
    ...
    public void act(){
        if(Greenfoot.mouseClicked(continueBtn)){
            ...
            Greenfoot.delay(62);
            if(this.player != null){
                Greenfoot.setWorld(new CutsceneStage2(this.player));    
            }
            else if(this.archer != null){
                Greenfoot.setWorld(new CutsceneStage2(this.archer));
            }
        }
    }
}
